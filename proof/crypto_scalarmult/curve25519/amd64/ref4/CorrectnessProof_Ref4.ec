...
require import Curve25519_Procedures Curve25519_auto4 Scalarmult_s W64limbs Zp_25519 Zplimbs EClib.

import Zp Curve25519_auto4 Curve25519_Procedures Scalarmult_s Array4 Array8 Array32 StdOrder.IntOrder EClib.
...
equiv eq_spec_impl_sqr_s__ref4 : CurveProcedures.sqr ~ M._sqr4_s_:
    f{1}   = inzpRep4 x{2}
    ==>
    res{1} = inzpRep4 res{2}.
proof.
...
proof.
    ...
    call eq_spec_impl_sqr_ss__ref4; wp.
...
proof.
    ...
    call eq_spec_impl_sqr_s__ref4; wp.
...
proof.
    proc => /=; wp.
    ecall {2} (ph_eq_to_bytes_ref4 (r{2})). wp.
    call eq_spec_impl_mul_rss_ref4. wp.
