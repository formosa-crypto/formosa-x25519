...
require import Curve25519_Procedures Curve25519_Operations Curve25519_auto_mulx Scalarmult_s W64limbs Zp_25519 Zplimbs EClib.

import Zp Curve25519_auto_mulx Curve25519_Operations Curve25519_Procedures Scalarmult_s Array4 Array8 Array32 StdOrder.IntOrder EClib.
...
proof.
    ...
    rewrite /DEC_32 /rflags_of_aluop_nocf_w => />. rewrite /ZF_of => *.
    smt(W32.ge2_modulus W32.of_uintK W32.to_uintK W32.to_uintN W32.of_intD).
    wp. call eq_spec_impl__sqr_rr_mulx_rev. wp. call eq_spec_impl__sqr_rr_mulx_rev. wp.
    skip => />. move => &1 H.
    do split. smt().
    rewrite /DEC_32 /rflags_of_aluop_nocf_w => />. rewrite /ZF_of => *.
    smt(W32.ge2_modulus W32.of_uintK W32.to_uintK W32.to_uintN W32.of_intD).
...
proof.
    proc. wp.
    ecall {2} (ph_eq_to_bytes_mulx (r{2})). wp.
